...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex" style={{ backgroundColor: 'var(--zinc-100)' }}>
      {/* Left Sidebar */}
      <div className="w-52 flex flex-col" style={{ backgroundColor: 'var(--zinc-100)'}}>
        {/* Header */}
        <div className="p-6">
          <h1 className="text-2xl font-bold mb-2" style={{ color: 'var(--zinc-1100)' }}>Creator Discovery</h1>
        ...
        <nav className="flex-1 p-4">
          {tabs.map((tab) => (
            <button
              ...
              style={{
                backgroundColor: activeTab === tab.id ? 'var(--color-gray-500)' : 'transparent',
                color: 'var(black)'
              }}
              onMouseEnter={(e) => {
                if (activeTab !== tab.id) {
